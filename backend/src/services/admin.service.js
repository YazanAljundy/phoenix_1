...
// (Audit C-1 / F-01): the old registerOrLogin handed back a token for whatever
// role the existing phone belonged to, so posting THIS warehouse's phone number
// to /auth/register returned a warehouse token. The number is not a secret - it
