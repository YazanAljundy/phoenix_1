...
const warehouseAdvertisementRoutes = require('./warehouseAdvertisement.routes');
const adminAdvertisementRoutes = require('./adminAdvertisement.routes');
...
const adminLedgerRoutes = require('./adminLedger.routes');
const adminCommissionRoutes = require('./adminCommission.routes');
...
const warehouseSettlementRoutes = require('./warehouseSettlement.routes');
...
router.use('/admin/advertisements', adminAdvertisementRoutes);
router.use('/admin/products', adminProductRoutes);
router.use('/admin/exchange-rate', adminExchangeRateRoutes);
router.use('/admin/ledger', adminLedgerRoutes);
...
router.use('/warehouse/advertisements', warehouseAdvertisementRoutes);
...
router.use('/warehouse/settlement', warehouseSettlementRoutes);
