...
class AuthCubit extends Cubit<AuthState> {
  ...
  // audit C-1) and has been closed. A known phone now comes back as a 409 with
  // code PHONE_ALREADY_REGISTERED, which error_translator.dart turns into a
  // message telling the user to sign in instead; the screen already offers a
  // link to PasswordLoginView.
